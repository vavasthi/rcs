...
public class Sensorrecordendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the sensorrecordendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   *
   * This request holds the parameters needed by the sensorrecordendpoint server.  After setting any
   * optional parameters, call the {@link GetSensorRecord#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @return the request
   ...
   *
   * This request holds the parameters needed by the sensorrecordendpoint server.  After setting any
   * optional parameters, call the {@link InsertSensorRecord#execute()} method to invoke the remote
   * operation.
   *
   ...
   *
   * This request holds the parameters needed by the sensorrecordendpoint server.  After setting any
   * optional parameters, call the {@link ListSensorRecord#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
   ...
   *
   * This request holds the parameters needed by the sensorrecordendpoint server.  After setting any
   * optional parameters, call the {@link RemoveSensorRecord#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @return the request
   ...
   *
   * This request holds the parameters needed by the sensorrecordendpoint server.  After setting any
   * optional parameters, call the {@link UpdateSensorRecord#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.avasthi.apps.roadconditionsensor.sensorrecordendpoint.model.SensorRecord}
   * @return the request
