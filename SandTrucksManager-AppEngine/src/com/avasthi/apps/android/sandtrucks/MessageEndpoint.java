 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "avasthi.com", ownerName = "avasthi.com", packagePath="apps.android.sandtrucks"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBxKyQUIqU99SZpmwbO-nRGJOEwkEXOqLg";
