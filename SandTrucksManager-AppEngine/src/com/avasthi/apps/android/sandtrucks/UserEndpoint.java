...
@Api(name = "userendpoint", namespace = @ApiNamespace(ownerDomain = "avasthi.com", ownerName = "avasthi.com", packagePath="apps.android.sandtrucks"))
public class UserEndpoint {
  ...
  private boolean containsUser(User user) {
    ...
    try {
      User item = mgr.find(User.class, user.getEmail());
      if(item == null) {
        contains = false;
      }
    } finally {
