 ...
 * on 2014-07-29 at 16:12:03 UTC 
 * Modify at your own risk.
 */

package com.avasthi.apps.android.sandtrucks.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<com.avasthi.apps.android.sandtrucks.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.String id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.avasthi.apps.android.sandtrucks.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.avasthi.apps.android.sandtrucks.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.avasthi.apps.android.sandtrucks.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.avasthi.apps.android.sandtrucks.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.avasthi.apps.android.sandtrucks.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.avasthi.apps.android.sandtrucks.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.avasthi.apps.android.sandtrucks.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.avasthi.apps.android.sandtrucks.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.avasthi.apps.android.sandtrucks.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.avasthi.apps.android.sandtrucks.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.avasthi.apps.android.sandtrucks.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.avasthi.apps.android.sandtrucks.userendpoint.model.User.class);
    }
