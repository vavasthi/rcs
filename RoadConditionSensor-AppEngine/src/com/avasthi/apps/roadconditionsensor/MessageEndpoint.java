 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "avasthi.com", ownerName = "avasthi.com", packagePath="apps.roadconditionsensor"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyCuZagLDlBi8mCdkXP9fz8PNVhcnqhvvzs";
